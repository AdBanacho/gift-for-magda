...
class Interface:
    ...
    def run(self):
        st.header("Chcesz uslyszec interesujace historie o Twojej rodzinie?")
        ...
        if st.button("Opowiadaj!", key=4):
            if self.topic == "Piotr":
                ...
                story = self.gpt.gpt_3(["competitive bike ride on the grand canyon", "amazing", "my son Igor"], 1.0, p.generate_prompt_story, 256)
